...
(function (global, factory) {
  ...
  var defaultParams = {
    ...
    position: "center",
    RankingSteps: [],
    currentRankingStep: null,
    RankingStepsDistance: null,
    onBeforeOpen: null,
    onOpen: null,
    onClose: null,
    useRejections: false,
  ...
  var getRankingSteps = function getRankingSteps() {
    return elementByClass(swalClasses.Rankingsteps);
  };
  ...
  function setParameters(params) {
    ...
    // Ranking steps
    var RankingStepsContainer = getRankingSteps();
    var currentRankingStep = parseInt(
      params.currentRankingStep === null
        ? sweetAlert.getQueueStep()
        : params.currentRankingStep,
      10
    );
    if (params.RankingSteps && params.RankingSteps.length) {
      show(RankingStepsContainer);
      empty(RankingStepsContainer);
      if (currentRankingStep >= params.RankingSteps.length) {
        warn(
          "Invalid currentRankingStep parameter, it should be less than RankingSteps.length " +
            "(currentRankingStep like JS arrays starts from 0)"
        );
      }
      params.RankingSteps.forEach(function (step, index) {
        var circle = document.createElement("li");
        addClass(circle, swalClasses.Rankingcircle);
        circle.innerHTML = step;
        if (index === currentRankingStep) {
          addClass(circle, swalClasses.activeRankingstep);
        }
        RankingStepsContainer.appendChild(circle);
        if (index !== params.RankingSteps.length - 1) {
          var line = document.createElement("li");
          addClass(line, swalClasses.Rankingline);
          if (params.RankingStepsDistance) {
            line.style.width = params.RankingStepsDistance;
          }
          RankingStepsContainer.appendChild(line);
        }
      });
    } else {
      hide(RankingStepsContainer);
    }
...
"undefined" != typeof document &&
  (function (e, t) {
    ...
    "@-webkit-keyframes swal2-show {\n" +
      ...
      "  padding: 0;\n" +
      "  font-weight: 600; }\n" +
      "  .swal2-Rankingsteps li {\n" +
      "    display: inline-block;\n" +
      "    position: relative; }\n" +
      "  .swal2-Rankingsteps .swal2-Rankingcircle {\n" +
      "    width: 2em;\n" +
      "    height: 2em;\n" +
      "    border-radius: 2em;\n" +
      "    background: #3085d6;\n" +
      ...
      "    text-align: center;\n" +
      "    z-index: 20; }\n" +
      "    .swal2-Rankingsteps .swal2-Rankingcircle:first-child {\n" +
      "      margin-left: 0; }\n" +
      "    .swal2-Rankingsteps .swal2-Rankingcircle:last-child {\n" +
      "      margin-right: 0; }\n" +
      "    .swal2-Rankingsteps .swal2-Rankingcircle.swal2-activeRankingstep {\n" +
      "      background: #3085d6; }\n" +
      "      .swal2-Rankingsteps .swal2-Rankingcircle.swal2-activeRankingstep ~ .swal2-Rankingcircle {\n" +
      "        background: #add8e6; }\n" +
      "      .swal2-Rankingsteps .swal2-Rankingcircle.swal2-activeRankingstep ~ .swal2-Rankingline {\n" +
      "        background: #add8e6; }\n" +
      "  .swal2-Rankingsteps .swal2-Rankingline {\n" +
      "    width: 2.5em;\n" +
      "    height: .4em;\n" +
      "    margin: 0 -1px;\n" +
      "    background: #3085d6;\n" +
